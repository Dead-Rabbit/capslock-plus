...
keySchemeInit_capslockPlus(){
	...
	if(!keyset.caps_n)
        keyset.caps_n:="keyFunc_inputNumber_zero"
    if(!keyset.caps_m)
        keyset.caps_m:="keyFunc_inputNumber(1)"
    if(!keyset.caps_comma)
        keyset.caps_comma:="keyFunc_inputNumber(2)"
    if(!keyset.caps_dot)
        keyset.caps_dot:="keyFunc_inputNumber(3)"
    if(!keyset.caps_j)
        keyset.caps_j:="keyFunc_inputNumber(4)"
    if(!keyset.caps_k)
        keyset.caps_k:="keyFunc_inputNumber(5)"
    if(!keyset.caps_l)
        keyset.caps_l:="keyFunc_inputNumber(6)"
    if(!keyset.caps_u)
        keyset.caps_u:="keyFunc_inputNumber(7)"
    if(!keyset.caps_i)
        keyset.caps_i:="keyFunc_inputNumber(8)"
    if(!keyset.caps_o)
        keyset.caps_o:="keyFunc_inputNumber(9)"
